...
console.log("Module 0208 Belajar Fundamental Aplikasi Back-End -- Hapi Plugin dan Data Validation- Membuat Notes Plugin- Membuat Router Notes");
console.log("routes.js");
console.log("");

// 00 Hapi Plugin dan Data Validation- Membuat Notes Plugin- Membuat Router Notes
console.log("00 Hapi Plugin dan Data Validation- Membuat Notes Plugin- Membuat Router Notes");

// Create routes anonymous arrow function expression object variable- const variable declaration statement
const routes = (handler) => [
  ...
  //   path: '/{any*}',
  //   handler: (request, h) => {
  //     return `<h1>Halaman ${request.url} tidak ditemukan!</h1>`;
  //   }
  // }
];
...
// Called by server.js
console.log("routes module called by server.js");
...
// Copy file 'routes.js' to Remote VPS Server (Linux) from Local Computer (Ms. PowerShell)
