...
console.log("Module 0200 Belajar Fundamental Aplikasi Back-End -- Hapi Plugin dan Data Validation");
console.log("notes.js");
console.log("");

// 00 Hapi Plugin dan Data Validation
console.log("00 Hapi Plugin dan Data Validation");
...
// Called by server.js
console.log("notes module called by server.js");
...
// Copy file 'notes.js' to Remote VPS Server (Linux) from Local Computer (Ms. PowerShell)
