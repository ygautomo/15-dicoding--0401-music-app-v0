...
console.log("Module 0217 Belajar Fundamental Aplikasi Back-End -- Hapi Plugin dan Data Validation- Menerapkan Data Validation pada Notes API- Membuat Notes Schema dan Validator");
console.log("schema.js");
console.log("");

// 00 Hapi Plugin dan Data Validation- Menerapkan Data Validation pada Notes API- Membuat Notes Schema dan Validator
console.log("00 Hapi Plugin dan Data Validation- Menerapkan Data Validation pada Notes API- Membuat Notes Schema dan Validator");

// Get class Joi assignment object (joi Node.js module destructuring) variable- const variable declaration statement
...
// Called by server.js
console.log("schema module called by server.js");
...
// Copy file 'schema.js' to Remote VPS Server (Linux) from Local Computer (Ms. PowerShell)
// pscp -i "D:\01 My Document\01 Credentials\rsa-key-development-private.ppk" -P 22 `
//   source "D:\06 Training Course\07 JavaScript\15 Dicoding -- Back-End Developer- Fundamental Back-End\0401-music-app-v0\src\validator\notes\schema.js" `
//   root@45.77.252.166:/home/developer/15-dicoding-back-end-fundamental/0401-music-app-v0/src/validator/notes/
