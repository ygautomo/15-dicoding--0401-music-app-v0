...
#  * Filename: 0401-git-setup-music-app-v0.sh
#  * Description: Project 15-dicoding Module -- MusicApp v0 Git setup repository
...
echo "Project 15-dicoding Module -- MusicApp v0 Git setup repository"
echo "0401-git-setup-music-app-v0.sh"
echo ""

# 00 Project 15-dicoding Module -- MusicApp v0 Git setup repository
echo "00 Project 15-dicoding Module -- MusicApp v0 Git setup repository"
...
# Step 01 Check installed Git version
  ...
  echo "Step 01 Check installed Git version"
...
# Step 02 Get GitHub account credentials and create/set working repository
  echo "Step 02 Get GitHub account credentials and create/set working repository"
  source ../0000-github-config.sh
  GITHUB_REPO="15-dicoding--0401-music-app-v0"
  echo $GITHUB_REPO
  echo $GITHUB_USER
  echo $GITHUB_EMAIL
  echo $GITHUB_TOKEN
...
# Step 03 Check current directory, create & change to working directory
  echo "Step 03 Check current directory, create & change to working directory"
...
# Step 04 Create Git local repository and set configuration
  echo "Step 04 Create Git local repository and set configuration"
...
# Step 05 Create README.md file
  echo "Step 05 Create README.md file"
...
# Step 06 Create .gitignore file
  echo "Step 06 Create .gitignore file"
...
# Step 07 Check Git remote repository
  echo "Step 07 Check Git remote repository"
  # curl -- transfer a URL
  # Get the Zen of GitHub
  curl [-X GET] [-i][-v] \
    -H "X-GitHub-Api-Version:2022-11-28" \
...
# Step 08 (Optional) Create Git remote repository
  echo "Step 08 (Optional) Create Git remote repository"
  # Create a repository for the authenticated user
  curl -X POST \
    -H "X-GitHub-Api-Version:2022-11-28" \
    -H "Accept:application/vnd.github.json" \
    -u "$GITHUB_USER:$GITHUB_TOKEN" \
    "https://api.github.com/user/repos?autoinit=true" \
    -d '{"name":$GITHUB_REPO, description" = "Project 15-dicoding Module -- 0401 MusicApp v0 Git setup repository (Git Bash)", "private":false}'

# Step 09 Add and track files to Git local repository
  echo "Step 09 Add and track files to Git local repository"
...
# Step 10 Upload tracked files and update Git remote repository
  echo "Step 10 Upload tracked files and update Git remote repository"
...
# Running Command on Local Computer (Linux)
# cd '/home/developer/15-dicoding-back-end-fundamental/0401-music-app-v0/'
# bash 0401-git-setup-music-app-v0.sh

# Dot Sourcing Operator .
# chmod a+x 0401-git-setup-music-app-v0.sh
# 0401-git-setup-music-app-v0.sh

# Copy file '0401-git-setup-music-app-v0.sh' to Remote Server (Linux) from Local Computer (Ms. PowerShell)
# pscp -i "D:\01 My Document\01 Credentials\rsa-key-development-private.ppk" -P 22 `
#   source "D:\06 Training Course\07 JavaScript\15 Dicoding -- Back-End Developer- Fundamental Back-End\0401-music-app-v0\0401-git-setup-music-app-v0.sh" `
